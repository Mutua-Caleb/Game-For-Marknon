...
function flashinput(event){
  ...
  if(typeof activeStudyMarkActivity == "function") activeStudyMarkActivity();
  ...
  if(event.key == "Enter"){
    ...
    if(numinput == flashcount){
      if(typeof activeStudyProblemComplete == "function") activeStudyProblemComplete(true);
      ...
      if(typeof activeStudyProblemComplete == "function") activeStudyProblemComplete(false);
